\begin{abstract}
    ...
    Umożliwia to łatwą integrację z innymi aplikacjami szachowymi oraz pozwala na przeprowadzanie symulacji i analiz działania silnika bez potrzeby aplikowania interfejsów graficznych.
...

{
    ...
    \begin{abstract}
        ...
        This allows for easy integration with other chess applications and facilitates the simulation and analysis of the engine's performance without the need to create graphical interfaces.
