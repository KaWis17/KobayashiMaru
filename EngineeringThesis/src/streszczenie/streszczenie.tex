...

{
    ...
    \begin{abstract}
        ...
        The result of the work is an engine, whose chess ranking can be estimated in the range between 1600 and 1700 ELO, which places it at a level comparable to a player with the title of 2nd Category.
    \end {abstract}
    \mykeywords}
