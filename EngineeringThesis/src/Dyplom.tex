...
\include{skroty/skroty}
% ROZDZIAŁY (kolejne rozdziały dołączane są z kolejnych plików)
\chapterstyle{default}

\include{rozdzialy/wstep/_wstep}
\include{rozdzialy/rozdzial01/_implementacja-silnika-szachowego}
\include{rozdzialy/rozdzial02/rozdzial02}
\include{rozdzialy/rozdzial03/rozdzial03}
\include{rozdzialy/zakonczenie/zakonczenie}
...
\printbibliography
\appendix
\include{dodatki/dodatekA/instrukcja-wdrozenia.tex}
\include{dodatki/dodatekB/przyklad-uci.tex}
\include{dodatki/dodatekC/wyniki-perft.tex}
